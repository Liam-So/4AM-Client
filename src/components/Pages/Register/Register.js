        ...
        <div>
            <section className="bg-white mt-20 mb-20">
                <div className="max-w-2xl px-6 text-center mx-auto">
                    ...
                    <p className="text-gray-600 mt-4">Click here to read how we will be delivering our basketball program while complying with the NS Provincal Health Guidelines in regard to the COVID-19 pandemic. We are committed to holding the safety of our athletes and coaches as our top priority. Athletes will be required to sign a waiver at the start of the camp and fill out COVID-19 screenings in advance of the camp and daily during the camp.</p>
